                ...
                {fromPilot && (
                    <div className="mt-3 text-center">
                        <Link
                            ...
                            className="text-xs font-medium text-[#7A92A8] hover:text-[#0B1B2B] dark:hover:text-white focus-visible:outline-2 focus-visible:outline-offset-2 outline-focus-ring rounded"
                        >
                            Back to your report
                        </Link>
                    </div>
