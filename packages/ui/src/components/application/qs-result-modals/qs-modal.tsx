...
export const qsModal = {
    ...
    header: "relative flex-shrink-0 border-b border-[#2A4A68] px-6 py-5 pr-12",
    title: "text-xl font-bold leading-tight text-white",
    subtitle: "mt-1 text-sm text-[#7A92A8]",
    accent: "text-[#00BFFF]",
    body: "flex-1 overflow-y-auto px-6 py-4",
    footer: "flex flex-shrink-0 gap-3 border-t border-[#2A4A68] px-6 py-4",
    close: "absolute top-4 right-4 z-10 text-[#7A92A8] transition-colors hover:text-white",
    card: "rounded-lg bg-[#022136] px-4 py-3",
    muted: "text-sm text-[#7A92A8]",
    bodyText: "text-sm text-[#B8C4CC]",
    input: cx(
        "h-[52px] w-full rounded-lg border px-4 py-3 text-sm",
        "border-[#2A4A68] bg-[#022136] text-white placeholder:text-[#7A92A8]",
        "outline-none transition focus:ring-2 focus:ring-[#00BFFF]",
    ),
    primaryBtn: cx(
        "rounded-lg bg-[#00BFFF] py-2.5 font-semibold text-[#022136]",
        "transition hover:bg-[#00D4FF] active:scale-[0.98]",
    ),
    secondaryBtn: cx(
        "rounded-lg border border-[#2A4A68] py-2.5 font-semibold text-[#B8C4CC]",
        "transition hover:bg-[#022136] active:scale-[0.98]",
    ),
    option: "flex w-full items-center gap-3 rounded-lg px-4 py-3 text-left text-sm text-white transition",
    optionOn: "bg-[#0B3B52] ring-1 ring-[#00BFFF]",
    optionOff: "bg-[#022136] hover:bg-[#0f1f2e]",
} as const;
