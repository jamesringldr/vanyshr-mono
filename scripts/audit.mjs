...
const AUDITED_SOURCE_FILES = [
  ...
  rel("packages/ui/src/components/application/scan-progress-card/scan-progress-card.tsx"),
  rel("apps/app/src/pages/find-my-data-loading.tsx"),
  rel("apps/app/src/components/ScanLoadingView.tsx"),
  rel("apps/app/src/components/BrandMark.tsx"),
